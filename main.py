...
def main():
    ...
    with gr.Blocks(title="Paper Dashi", theme=set_theme, analytics_enabled=False, css=advanced_css) as demo:
        ...
        btnQueryAI.click(fn=query_ai, inputs=[cookies, txt, txt2, chatbot, history], outputs=output_combo)
        btnVoidAi.click(fn=void_ai, inputs=[cookies, txt,txt2, chatbot, history], outputs=output_combo)
